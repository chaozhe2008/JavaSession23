...
public class Cryptogram extends Window {
    public static final int W = 18, H = 50;
    public static final int dCode = 18, dGuess = 40;
    public static final int xM = 100, yM = 100, SPACE = 20, LINEGAP = 45; // margin, space between chars and gap between lines
...
//        Cell c = new Cell(Pair.alpha[2]);
    ...
    public static class Pair{
        ...
        static{
            for(int i = 0; i < 26; i++){
                alpha[i] = new Pair((char)('A' + i)); //cast from integer to char
        ...
        public static void init() {
            for(int i = 0; i < 26; i++){
                ...
                char c = p.code; p.code = x.code; x.code = c; //pick a random letter and swap
            }
        }
    }
}
